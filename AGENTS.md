...
Responsibilities
	...
	• Build all pages (Home, About, Services, Pricing, Contact, etc.)
	• Implement the brand style guide (colors, typography, layout)
...
Success Criteria
	• Website loads quickly (<2 seconds on broadband)
	...
	• Secure SSL configuration and no mixed‑content warnings
Communication Style
...
Tools & Technologies (Flexible)
The Site Builder Agent may use any appropriate stack, such as:
	• Static site generators
	• CMS platforms
	• Custom HTML/CSS/JS
	• Hosting platforms
	• DNS/SSL management tools
The exact stack is chosen based on performance, maintainability, and simplicity.
